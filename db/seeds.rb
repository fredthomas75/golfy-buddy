...
User.create!(name: 'Younes Kamel', first_name: 'Younes', last_name: 'Kamel', language: "French", email: 'younes@email.com', password: '123456', about_me: "I am Younes", current_city: 'Montreal', gender: 'Other', photo: File.open('./app/assets/images/younes.jpg'))
puts 'Creation de leo@email.com:123456'
User.create!(name: 'Leo Beltran', first_name: 'Leo', last_name: 'Beltran', language: "French", email: 'leo@email.com', password: '123456', about_me: "I am a guest", current_city: 'Montreal', gender: 'Other', photo: File.open('./app/assets/images/leo.jpg'))
puts 'Creation de fred@email.com:123456'
User.create!(name: 'Frederic Thomas', first_name: 'Frederic', last_name: 'Thomas', language: "French", email: 'fred@email.com', password: '123456', about_me: "I am a guest", current_city: 'Montreal', gender: 'Other', photo: File.open('./app/assets/images/fred.png'))
puts 'Creation de louis@email.com:123456'
User.create!(name: 'Louis-Olivier', first_name: 'Louis-Olivier', last_name: 'Pelletier', language: "French", email: 'louis@email.com', password: '123456', about_me: "I am a guest", current_city: 'Montreal', gender: 'Other', photo: File.open('./app/assets/images/louis.png'))
